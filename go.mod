...
require (
	...
	github.com/brevis-network/brevis-kafka-utils v0.0.0-20250711063559-1bba12271c27
...
replace (
	...
	github.com/ethereum/go-ethereum => github.com/celer-network/go-ethereum v0.0.0-20250328211401-63ec28a3ab84
)
