...
func (c *proverClient) ProveAsync(ctx context.Context, in *ProveRequest, opts ...grpc.CallOption) (*ProveAsyncResponse, error) {
	...
	err := c.cc.Invoke(ctx, Prover_ProveAsync_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *proverClient) GetProof(ctx context.Context, in *GetProofRequest, opts ...grpc.CallOption) (*GetProofResponse, error) {
	...
	err := c.cc.Invoke(ctx, Prover_GetProof_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *proverClient) DeleteProof(ctx context.Context, in *DeleteProofRequest, opts ...grpc.CallOption) (*DeleteProofResponse, error) {
	...
	err := c.cc.Invoke(ctx, Prover_DeleteProof_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *proverClient) Health(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthResponse, error) {
	...
	err := c.cc.Invoke(ctx, Prover_Health_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedProverServer should be embedded to have
...
func _Prover_DeleteProof_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Prover_DeleteProof_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
