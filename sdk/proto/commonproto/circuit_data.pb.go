...
type VmAppCircuitInfo struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	MaxReceipts      uint32                 `protobuf:"varint,1,opt,name=max_receipts,json=maxReceipts,proto3" json:"max_receipts,omitempty"`
	MaxStorage       uint32                 `protobuf:"varint,2,opt,name=max_storage,json=maxStorage,proto3" json:"max_storage,omitempty"`
	MaxTx            uint32                 `protobuf:"varint,3,opt,name=max_tx,json=maxTx,proto3" json:"max_tx,omitempty"`
	MaxNumDataPoints uint32                 `protobuf:"varint,4,opt,name=max_num_data_points,json=maxNumDataPoints,proto3" json:"max_num_data_points,omitempty"`
	PublicValues     string                 `protobuf:"bytes,5,opt,name=public_values,json=publicValues,proto3" json:"public_values,omitempty"`
	WitnessJsonHex   string                 `protobuf:"bytes,6,opt,name=witness_json_hex,json=witnessJsonHex,proto3" json:"witness_json_hex,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *VmAppCircuitInfo) GetPublicValues() string {
	if x != nil {
...
func (x *VmAppCircuitInfo) GetWitnessJsonHex() string {
	if x != nil {
		return x.WitnessJsonHex
	}
	return ""
}
...
const file_common_circuit_data_proto_rawDesc = "" +
	"\n" +
	"\x19common/circuit_data.proto\x12\x06common\"\xf5\x03\n" +
	"\x0eAppCircuitInfo\x12+\n" +
	"\x11output_commitment\x18\x01 \x01(\tR\x10outputCommitment\x12\x0e\n" +
	"\x02vk\x18\x02 \x01(\tR\x02vk\x12+\n" +
	"\x11input_commitments\x18\x03 \x03(\tR\x10inputCommitments\x121\n" +
	"\x12toggles_commitment\x18\x04 \x01(\tB\x02\x18\x01R\x11togglesCommitment\x12\x18\n" +
	"\atoggles\x18\x05 \x03(\bR\atoggles\x12!\n" +
	"\fuse_callback\x18\x06 \x01(\bR\vuseCallback\x12\x16\n" +
	"\x06output\x18\a \x01(\tR\x06output\x12\x17\n" +
	"\avk_hash\x18\b \x01(\tR\x06vkHash\x124\n" +
	"\x16input_commitments_root\x18\t \x01(\tR\x14inputCommitmentsRoot\x12\x18\n" +
	"\awitness\x18\n" +
	" \x01(\tR\awitness\x12!\n" +
	"\fmax_receipts\x18\v \x01(\rR\vmaxReceipts\x12\x1f\n" +
	"\vmax_storage\x18\f \x01(\rR\n" +
	"maxStorage\x12\x15\n" +
	"\x06max_tx\x18\r \x01(\rR\x05maxTx\x12-\n" +
	"\x13max_num_data_points\x18\x0e \x01(\rR\x10maxNumDataPoints\"\x86\x04\n" +
	"\x17AppCircuitInfoWithProof\x12+\n" +
	"\x11output_commitment\x18\x01 \x01(\tR\x10outputCommitment\x12\x17\n" +
	"\avk_hash\x18\x02 \x01(\tR\x06vkHash\x12+\n" +
	"\x11input_commitments\x18\x03 \x03(\tR\x10inputCommitments\x121\n" +
	"\x12toggles_commitment\x18\x04 \x01(\tB\x02\x18\x01R\x11togglesCommitment\x12\x18\n" +
	"\atoggles\x18\x05 \x03(\bR\atoggles\x12\x16\n" +
	"\x06output\x18\x06 \x01(\tR\x06output\x12\x14\n" +
	"\x05proof\x18\a \x01(\tR\x05proof\x12#\n" +
	"\rcallback_addr\x18\b \x01(\tR\fcallbackAddr\x124\n" +
	"\x16input_commitments_root\x18\t \x01(\tR\x14inputCommitmentsRoot\x12\x18\n" +
	"\awitness\x18\n" +
	" \x01(\tR\awitness\x12!\n" +
	"\fmax_receipts\x18\v \x01(\rR\vmaxReceipts\x12\x1f\n" +
	...
	"maxStorage\x12\x15\n" +
	"\x06max_tx\x18\r \x01(\rR\x05maxTx\x12-\n" +
	"\x13max_num_data_points\x18\x0e \x01(\rR\x10maxNumDataPoints\"\xeb\x01\n" +
	"\x10VmAppCircuitInfo\x12!\n" +
	"\fmax_receipts\x18\x01 \x01(\rR\vmaxReceipts\x12\x1f\n" +
	"\vmax_storage\x18\x02 \x01(\rR\n" +
	"maxStorage\x12\x15\n" +
	"\x06max_tx\x18\x03 \x01(\rR\x05maxTx\x12-\n" +
	"\x13max_num_data_points\x18\x04 \x01(\rR\x10maxNumDataPoints\x12#\n" +
	"\rpublic_values\x18\x05 \x01(\tR\fpublicValues\x12(\n" +
	"\x10witness_json_hex\x18\x06 \x01(\tR\x0ewitnessJsonHexb\x06proto3"

var (
	file_common_circuit_data_proto_rawDescOnce sync.Once
	file_common_circuit_data_proto_rawDescData []byte
)

func file_common_circuit_data_proto_rawDescGZIP() []byte {
	file_common_circuit_data_proto_rawDescOnce.Do(func() {
		file_common_circuit_data_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_common_circuit_data_proto_rawDesc), len(file_common_circuit_data_proto_rawDesc)))
	})
...
func file_common_circuit_data_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_circuit_data_proto_rawDesc), len(file_common_circuit_data_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
