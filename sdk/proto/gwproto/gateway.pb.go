...
var file_brevis_gateway_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x04, 0x52, 0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x22, 0x16, 0x0a, 0x14, 0x43, 0x69,
	...
	0x55, 0x4e, 0x44, 0x45, 0x44, 0x10, 0x11, 0x32, 0xa7, 0x08, 0x0a, 0x07, 0x47, 0x61, 0x74, 0x65,
	...
	0x69, 0x65, 0x73, 0x12, 0x6d, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x43, 0x69, 0x72, 0x63, 0x75, 0x69,
...
var file_brevis_gateway_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_brevis_gateway_proto_goTypes = []interface{}{
	...
	(*CircuitDigestRequest)(nil),                // 20: brevis.CircuitDigestRequest
	(*CircuitDigestResponse)(nil),               // 21: brevis.CircuitDigestResponse
	(*CircuitDummyInputRequest)(nil),            // 22: brevis.CircuitDummyInputRequest
	(*CircuitDummyInputResponse)(nil),           // 23: brevis.CircuitDummyInputResponse
	(*SubmitVKRequest)(nil),                     // 24: brevis.SubmitVKRequest
	(*SubmitVKResponse)(nil),                    // 25: brevis.SubmitVKResponse
	(*ReceiptInfo)(nil),                         // 26: brevis.ReceiptInfo
	(*StorageQueryInfo)(nil),                    // 27: brevis.StorageQueryInfo
	(*TransactionInfo)(nil),                     // 28: brevis.TransactionInfo
	(*commonproto.AppCircuitInfo)(nil),          // 29: common.AppCircuitInfo
	(*commonproto.AppCircuitInfoWithProof)(nil), // 30: common.AppCircuitInfoWithProof
}
var file_brevis_gateway_proto_depIdxs = []int32{
	0,  // 0: brevis.ErrMsg.code:type_name -> brevis.ErrCode
	26, // 1: brevis.PrepareQueryRequest.receipt_infos:type_name -> brevis.ReceiptInfo
	27, // 2: brevis.PrepareQueryRequest.storage_query_infos:type_name -> brevis.StorageQueryInfo
	28, // 3: brevis.PrepareQueryRequest.transaction_infos:type_name -> brevis.TransactionInfo
	29, // 4: brevis.PrepareQueryRequest.app_circuit_info:type_name -> common.AppCircuitInfo
	...
	26, // 20: brevis.Query.receipt_infos:type_name -> brevis.ReceiptInfo
	27, // 21: brevis.Query.storage_query_infos:type_name -> brevis.StorageQueryInfo
	28, // 22: brevis.Query.transaction_infos:type_name -> brevis.TransactionInfo
	30, // 23: brevis.Query.app_circuit_info:type_name -> common.AppCircuitInfoWithProof
	...
	4,  // 26: brevis.CircuitDigestResponse.err:type_name -> brevis.ErrMsg
	4,  // 27: brevis.CircuitDummyInputResponse.err:type_name -> brevis.ErrMsg
	4,  // 28: brevis.SubmitVKResponse.err:type_name -> brevis.ErrMsg
	5,  // 29: brevis.Gateway.PrepareQuery:input_type -> brevis.PrepareQueryRequest
	7,  // 30: brevis.Gateway.SubmitAppCircuitProof:input_type -> brevis.SubmitAppCircuitProofRequest
	9,  // 31: brevis.Gateway.GetQueryStatus:input_type -> brevis.GetQueryStatusRequest
	11, // 32: brevis.Gateway.GetQueryInfoForOP:input_type -> brevis.GetQueryInfoForOPRequest
	13, // 33: brevis.Gateway.GetSingleRunParams:input_type -> brevis.GetSingleRunParamsRequest
	16, // 34: brevis.Gateway.SendBatchQueries:input_type -> brevis.SendBatchQueriesRequest
	20, // 35: brevis.Gateway.GetCircuitDigest:input_type -> brevis.CircuitDigestRequest
	22, // 36: brevis.Gateway.GetCircuitDummyInputRequest:input_type -> brevis.CircuitDummyInputRequest
	24, // 37: brevis.Gateway.SubmitVK:input_type -> brevis.SubmitVKRequest
	6,  // 38: brevis.Gateway.PrepareQuery:output_type -> brevis.PrepareQueryResponse
	8,  // 39: brevis.Gateway.SubmitAppCircuitProof:output_type -> brevis.SubmitAppCircuitProofResponse
	10, // 40: brevis.Gateway.GetQueryStatus:output_type -> brevis.GetQueryStatusResponse
	12, // 41: brevis.Gateway.GetQueryInfoForOP:output_type -> brevis.GetQueryInfoForOPResponse
	14, // 42: brevis.Gateway.GetSingleRunParams:output_type -> brevis.GetSingleRunParamsResponse
	18, // 43: brevis.Gateway.SendBatchQueries:output_type -> brevis.SendBatchQueriesResponse
	21, // 44: brevis.Gateway.GetCircuitDigest:output_type -> brevis.CircuitDigestResponse
	23, // 45: brevis.Gateway.GetCircuitDummyInputRequest:output_type -> brevis.CircuitDummyInputResponse
	25, // 46: brevis.Gateway.SubmitVK:output_type -> brevis.SubmitVKResponse
