# Uniswap V2 Liquidity Provider Tracking Circuit

## Overview

This circuit proves that a user provided liquidity to a Uniswap V2 pair by analyzing **Mint events** (not Swap events).
...
- Uniswap V2 Trading Volume (Swap events)
- SushiSwap LP Tracking (identical logic)
