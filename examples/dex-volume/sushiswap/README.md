# SushiSwap Trading Volume Circuit

## Overview

This circuit proves that a user traded **≥ minimum threshold volume** on SushiSwap without revealing:
...
- **Receipts**: Up to 50 Swap events from SushiSwap USDC/WETH pair
- **Contract**: `0x397FF1542f962076d0BFE58eA045FfA2d347ACa0` (SushiSwap USDC/WETH pair)
...
app.AddReceipt(sdk.ReceiptData{
    ...
    Fields: []*sdk.LogFieldData{
        {
            Contract: "0x397FF1542f962076d0BFE58eA045FfA2d347ACa0",  // SushiSwap pair
            LogPos:   0,
            IsTopic:  true,
